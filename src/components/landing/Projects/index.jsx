  ...
  const projectInfo = {
    "Muzero Implementation": {
      ...
      imageComponent: (
        <StaticImage
          height="200"
          src="../../../assets/muzero2_illustration.png"
    ...
    "Reinforcement Learning Paper Implementations": {
      description:
        "A compilation of RL algorithms implemented in Pytorch, representing an initial step in my journey towards proficiency in reading and implementing RL algorithms.",
      learnings: [
      ...
      imageComponent: (
        <StaticImage
          height="200"
          src="../../../assets/rl_papers2_illustration.png"
          alt="Illustration of a man inventing AI to be used in games"
        />
      ),
      startTime: "2021",
    },
    Unchart: {
      description:
        "A startup idea I implemented to facilitate reading books in other languages, featuring an Elixir GraphQL backend and Purescript React Native frontend.",
      learnings: [
      ...
      imageComponent: (
        <StaticImage
          height="200"
          src="../../../assets/unchart_illustration.png"
          alt="Illustration of a book that is combined with a computer"
        />
      ),
      startTime: "2020",
    },
    "Fast.ai course and beginning interest in machine learning": {
      description:
        "A period of learning and exploration in the field of AI and deep learning, including participation in the fast.ai course and Kaggle competitions, as well as delving into the underlying theory of deep learning and AI.",
      learnings: [
      ...
      imageComponent: (
        <StaticImage
          height="200"
          src="../../../assets/neural_net_illustration.png"
          alt="Illustration of a stylized neural net"
        />
      ),
      startTime: "2018",
    },
    "Interactive Code Portfolio": {
      description:
        "A project developed with Purescript that aimed to create an interactive code-first portfolio.",
      learnings: [
      ...
      imageComponent: (
        <StaticImage
          height="200"
          src="../../../assets/code_portfolio_illustration.png"
          alt="Illustration of a computer higher than trees showing off code"
        />
      ),
      startTime: "2017",
    },
    "Make a Lisp": {
      ...
      imageComponent: (
        <StaticImage
          height="200"
          src="../../../assets/make_a_lisp_illustration.png"
          alt="Illustration of a computer higher than trees showing off code"
        />
      ),
      startTime: "2016",
